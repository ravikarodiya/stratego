...
<div class="h-full">
    <div class="px-view py-view padding-top-8 h-main width-40 pos-absolute">
            ...
            <form class="pos-relative max-w-login mx-auto " method="POST" action="{{ route('register') }}">
                @csrf
                <h2 class="text-2xl text-left font-normal mb-6 text-90 h-sign">Create your account</h2>

                <div class="form-group row" style="display:none;">
                    <div class="col-md-6">
                        <input id="email" type="email" class="form-control" name="email" value="{{ (old('email')) ? old('email') : base64_decode(Request::get('email'))  }}" required autocomplete="email">
                    </div>
                </div>
                ...
                <div class="mb-6 ">
                    <label class="block font-bold mb-2 login-email" for="email">Complete name</label>
                    <input class="form-control @error('name') is-invalid @enderror form-input form-input-bordered w-full input-name h-10" id="name" type="text" name="name" value="{{ old('name') }}" required="" autofocus="">
                ...
                <div class="mb-6 ">
                    <label class="block font-bold mb-2 login-email d-inline" for="password">Password</label>
                    <input class="form-control  @error('password') is-invalid @enderror form-input form-input-bordered w-full input-email h-10" id="password" type="password" name="password" required="" >
                ...
                <!-- <div class="mb-6 ">
                    <label class="block font-bold mb-2 login-email" for="email">Name one of your business unit</label>
                    <input class="form-control form-input form-input-bordered w-full input-name h-10" id="name" type="text" name="name" value="" required="" autofocus="">
                </div>

                <div class="mb-6 ">
                    <label class="block font-bold mb-2 login-email" for="email">Name the team responsible for the unit</label>
                    <input class="form-control form-input form-input-bordered w-full input-name h-10" id="name" type="text" name="name" value="" required="" autofocus="">
                </div> -->
    ...
    <div class="signup-right px-view py-view padding-top-8 h-main width-50 align-right-0 h-full"></div>
</div>
