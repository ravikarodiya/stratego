...
<div class="h-full">
    <div class="px-view py-view padding-top-8 h-main width-40 pos-absolute">
            ...
            <form class="pos-relative max-w-login mx-auto " method="POST" action="{{route('signupCreateSubmit')}}">
                @csrf

                <h2 class="text-2xl text-left font-normal mb-6 text-90 h-sign">Sign up</h2>
                ...
                <div class="mb-6 ">
                    <label class="block font-bold mb-2 login-email" for="email">Email Address</label>
